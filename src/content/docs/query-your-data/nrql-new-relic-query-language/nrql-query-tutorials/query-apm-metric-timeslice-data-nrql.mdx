...
APM reports metric data in the form of [metric timeslice data](/docs/using-new-relic/data/understand-data/new-relic-data-types#timeslice-data), and you can use [NRQL](/docs/query-your-data/nrql-new-relic-query-language/get-started/introduction-nrql-new-relics-query-language) to query and facet this type of data. To explore timeslice data in the data explorer, see [Explore your metrics](/docs/query-your-data/explore-query-data/data-explorer/introduction-data-explorer#blocks-metrics).
...
We recommend querying APM metric timeslice data using New Relic One [query builder in advanced mode](/docs/chart-builder/use-chart-builder/choose-data/use-advanced-nrql-mode-specify-data). This experience offers full NRQL functionality, and also gives helpful auto-complete suggestions and feedback on query errors.

You can also incorporate NRQL queries in our [NerdGraph (GraphQL) API](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph).
...
The conversion of original APM metric timeslice metrics into dimensional metrics that are available for querying is an ongoing process and isn't complete. If you don't see a metric you're looking for in this section, see [Generic queries](#generic-queries).
...
![New Relic One chart builder - metric timeslice NRQL query ](./images/new-relic-one-nrql-query-metric-timeslice-data.png "new-relic-one-nrql-query-metric-timeslice-data.png")
...
<CollapserGroup>
  ...
  >
    ...
    Instead of using `host`, you can facet by other [host-related attributes](https://docs.newrelic.com/node/36916/revisions/402556/view#infrastructure-attributes), like `host.bootId`.
  </Collapser>
