...
<Callout variant="tip">
  The same algorithm is used for the distribution metric type in [events to metrics service](https://docs.newrelic.com/docs/accounts/accounts/data-management/events-metrics-create-metrics). So whether you are directly querying events or querying via distribution metrics, your results will be equally accurate.
</Callout>
