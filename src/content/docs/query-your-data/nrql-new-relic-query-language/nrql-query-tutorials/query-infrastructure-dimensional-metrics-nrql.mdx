...
The [query builder](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder) in [New Relic One](https://one.newrelic.com/) supports metrics in both simple and advanced (NRQL) mode.
...
![naming-convention.png](./images/naming-convention.png "naming-convention.png")
