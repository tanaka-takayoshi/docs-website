...
topics:
  ...
  - Query builder
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/query-your-data/explore-query-data/query-builder/use-advanced-nrql-mode-query-data
---
...
Queries written directly in NRQL can be more complex than queries written in basic mode. The [NRQL documentation](/docs/insights/nrql-new-relic-query-language/using-nrql/introduction-nrql) contains both reference information and query examples. This table identifies some items to keep in mind.
