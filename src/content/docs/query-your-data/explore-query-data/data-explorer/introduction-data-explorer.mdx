...
To access the data explorer, go to [one.newrelic.com](https://one.newrelic.com) and at the top of the page, click the **Query your data** icon.
...
![data_explorer_new.png](./images/data_explorer_new.png "data_explorer_new.png")
...
<CollapserGroup>
  ...
  >
    ...
    <Callout variant="important">
      Need to do more advanced searches or customize your charts? From data explorer you can access [query builder](/docs/chart-builder/use-chart-builder/choose-data/use-advanced-nrql-mode-specify-data) to edit the query.
    </Callout>
  </Collapser>
  ...
  <Collapser
    ...
    title="Chart area"
  >
    By default data is displayed on a **line chart**. You can easily change to **Area chart**, **Pie chart**, and B**ar chart** using the chart picker. You can also choose to see your results' **r\*\***aw data** as a table, or as in **JSON format\*\*.
