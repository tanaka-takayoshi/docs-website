...
topics:
  ...
  - Dashboards
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/query-your-data/explore-query-data/dashboards/manage-your-dashboard
---
...
![Dashboards_conf.png](./images/Dashboards_conf.png "Dashboards_conf.png")

<Callout variant="tip">
  Click the <Icon name="info"/>
  icon to access the **See metadata and manage tags** modal. There you can see the dashboard's guid, account ID, and App ID, and manage all the tags that have been added to the dashboard.
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    * When viewing a dashboard in New Relic One, select the <i className="fa fa-tv"><span>[TV icon]</span></i>
      icon at the top right.
    * Add this parameter to a dashboard page URL: `&platform[tvMode]=true`

    To configure TV mode, from a dashboard, select the <Icon name="settings"/>
  ...
  <Collapser
    ...
    title="Dark mode"
  >
    High-contrast mode is available in dashboards. Select the <i className="fa fa-moon-o"><span>[Dark mode]</span></i>
  ...
  >
    You can export your dashboard as a pdf file clicking the <i className="fa fa-download"><span>[Download]</span></i>
    icon.
  </Collapser>
</CollapserGroup>
...
You can also edit existing content by clicking the ellipses <Icon name="more-horizontal"/>
...
1. From a new or existing dashboard, enter edit mode by selecting the <Icon name="edit-2"/>
   icon.
2. Add a new page:
...
From any markdown element, access the menu on the upper right corner [to edit or delete it](/docs/dashboards/new-relic-one-dashboards/manage-your-dashboard/add-custom-content-dashboard-using-markdown).
