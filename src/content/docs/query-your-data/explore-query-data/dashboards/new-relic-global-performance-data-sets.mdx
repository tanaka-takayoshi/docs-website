...
topics:
  ...
  - Dashboards
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/query-your-data/explore-query-data/dashboards/new-relic-global-performance-data-sets
---

New Relic’s Global Performance data sets, a part of the [Telemetry Data Platform](/docs/data-ingest-apis/get-data-new-relic/getting-started/get-started-telemetry-data-platform), offer immediate access to meaningful, large-scale, aggregated telemetry data.
