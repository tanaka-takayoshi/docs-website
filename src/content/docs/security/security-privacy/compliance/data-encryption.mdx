...
topics:
  ...
  - Compliance
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/security/security-privacy/compliance/data-encryption
---
...
<Table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Account-level data encryption depends on your New Relic subscription and your [account hierarchy](/docs/accounts/install-new-relic/account-setup/manage-apps-or-users-sub-accounts). For example, if your data is encrypted at the master account level, your sub-account data also is automatically encrypted at rest.
