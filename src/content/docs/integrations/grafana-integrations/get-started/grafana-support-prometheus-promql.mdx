...
topics:
  ...
  - Get started
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/integrations/grafana-integrations/get-started/grafana-support-prometheus-promql
---

Our Prometheus API emulates Prometheus' query APIs. In Grafana, you can configure New Relic as a Prometheus data source. Not only that, within Grafana you can query metrics stored in New Relic using the [PromQL query language](/docs/integrations/prometheus-integrations/view-query-data/supported-promql-features).
