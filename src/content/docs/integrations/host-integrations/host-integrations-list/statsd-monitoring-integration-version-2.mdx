...
The second version of our StatsD integration was released on May 25 2020. It's an improvement on our [first StatsD integration](/docs/integrations/host-integrations/host-integrations-list/statsd-monitoring-integration). Improvements include: simpler configuration, and a simpler method for adding tags (key-value pairs).

## Features

Our StatsD integration (version 2) lets you easily get [StatsD](https://github.com/statsd/statsd)-format data into New Relic. You can also add any arbitrary tags (key-value pairs) to your data. Once your metrics are in New Relic, you can [query your data](#find-use-data) and create custom charts and dashboards.
