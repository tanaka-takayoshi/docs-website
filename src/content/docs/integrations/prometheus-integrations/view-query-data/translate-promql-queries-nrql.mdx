...
<Callout variant="tip">
  To run PromQL-style queries in [New Relic One](/docs/new-relic-one/use-new-relic-one/get-started/introduction-new-relic-one), go to the [query builder advanced PromQL-style mode](/docs/query-your-data/explore-query-data/chart-builder/use-advanced-promql-mode-specify-data).
</Callout>
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Prometheus automatically maps a summary to a set of counters and gauges. These can be translated to New Relic counts and gauges.
      </td>
    </tr>
...
<Callout variant="tip">
  To see how New Relic translates PromQL-style queries to NRQL, write a query in the [query builder PromQL-style tab](/docs/query-your-data/explore-query-data/chart-builder/use-advanced-promql-mode-specify-data), then switch to the [NRQL tab](/docs/chart-builder/use-chart-builder/choose-data/use-advanced-nrql-mode-specify-data).
</Callout>
...
<CollapserGroup>
  ...
  >
    ...
    **2. Filter the query results.**
    ...
    ![a query using PromQL](./images/PROMQL-query-2.png "PROMQL-query-2.png")
  ...
  >
    ...
    **4. View metrics by ID.**
    ...
    ![NRQL-query-example-4.png](./images/NRQL-query-example-4.png "NRQL-query-example-4.png")
    ...
    **5. Add the selected ID to the query.**
    ...
    ![NRQL-query-example-5.png](./images/NRQL-query-example-5.png "NRQL-query-example-5.png")
