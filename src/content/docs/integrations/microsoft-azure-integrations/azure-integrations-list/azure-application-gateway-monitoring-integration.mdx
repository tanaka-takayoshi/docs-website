...
[New Relic includes an integration](https://docs.newrelic.com/docs/infrastructure/integrations-getting-started/getting-started/introduction-infrastructure-integrations) for reporting your Azure App Gateway data to our platform. Here we explain how to activate the integration and what data it collects.
