---
title: >-
  Optimize cloud architecture and spend to continuously improve your modern
  cloud environment
contentType: page
template: basicDoc
topics:
...
* For a quick primer on the New Relic platform, check out [Learn the New Relic Digital Intelligence Platform in 30 Minutes or Less](https://blog.newrelic.com/2017/10/16/digital-intelligence-platform-learn-video/).
