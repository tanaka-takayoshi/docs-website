---
title: >-
  Set proactive alerts and align teams, tools, and processes for incident
  response 
contentType: page
template: basicDoc
topics:
...
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/new-relic-solutions/new-relic-solutions/optimize-your-cloud-native-environment/set-proactive-alerts-align-teams-tools-processes-incident-response
---
    ...
    <Table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            [New Relic Browser](/docs/browser) and [New Relic APM](/docs/apm) can be used to alert on site availability.
          </td>
        </tr>
...
Use the [New Relic query language](/docs/insights/nrql-new-relic-query-language/using-nrql/introduction-nrql) and the [Insights query API](/docs/insights/insights-api/get-data/query-insights-event-data-api) to create your dashboards. For detailed instructions, check out [Sending alerts data to Insights](https://blog.newrelic.com/2016/03/21/sending-alerts-data-to-insights/).
...
In addition to instrumenting and measuring application and infrastructure metrics, mature DevOps organizations often [measure and optimize the efficiency of incident response processes](https://blog.newrelic.com/2018/02/13/new-relic-incident-response/). For example, you can use webhooks to send alert events to [New Relic Insights](/docs/insights/use-insights-ui/getting-started/introduction-new-relic-insights). This allows you to [supplement your team dashboards with New Relic Alerts data](https://discuss.newrelic.com/t/sending-alerts-data-to-insights/34693).
