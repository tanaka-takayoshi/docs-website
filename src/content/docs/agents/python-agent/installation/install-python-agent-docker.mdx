...
1. Generate or download the `newrelic.ini` file described in the [Python agent configuration docs](https://docs.newrelic.com/docs/agents/python-agent/configuration/python-agent-configuration#agent-configuration-file).
2. Edit the `newrelic.ini` file to configure your settings. See the [Python agent configuration documentation](https://docs.newrelic.com/docs/agents/python-agent/configuration/python-agent-configuration) for more details.
