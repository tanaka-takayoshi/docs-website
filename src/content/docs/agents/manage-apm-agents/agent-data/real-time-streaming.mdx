...
To enable real time streaming, [update](/docs/agents/manage-apm-agents/installation/update-new-relic-agent) to the latest New Relic APM agent. You don't need to configure anything to enable real time streaming; it will automatically report faster!
...
2. Use the [chart builder](/docs/chart-builder/use-chart-builder/get-started/introduction-chart-builder) to start building a chart.
