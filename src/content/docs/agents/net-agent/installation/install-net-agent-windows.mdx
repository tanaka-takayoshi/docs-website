...
topics:
  ...
  - Installation
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/agents/net-agent/installation/install-net-agent-windows
---
...
3. Run the install wizard. Tips for using the install wizard:
   ...
   * When prompted, input your [New Relic license key](/docs/accounts-partnerships/accounts/account-setup/license-key).
...
4. For each application you wish to monitor, give your application [a meaningful name](/docs/agents/net-agent/installation-and-configuration/naming-your-net-application).
