...
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/accounts/accounts-billing/new-relic-one-pricing-users/usage-queries-alerts
---
...
Usage data is attached to two [events](/docs/using-new-relic/data/understand-data/new-relic-data-types#events-new-relic):
...
To look at changes made to your New Relic account, you can query [`NrAuditEvent`](/docs/insights/insights-data-sources/default-data/nrauditevent-event-data-query-examples).
