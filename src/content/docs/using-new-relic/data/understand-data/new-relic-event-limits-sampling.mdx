...
* Custom events reported via agent API (example: the .NET agent's [RecordCustomEvent](https://docs.newrelic.com/docs/agents/net-agent/net-agent-api/record-custom-event))
* `Mobile`
* `MobileRequest`
* `MobileCrash`
