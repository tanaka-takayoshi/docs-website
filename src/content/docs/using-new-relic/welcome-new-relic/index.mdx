...
![New Relic APM Overview](https://docs.newrelic.com/sites/default/files/thumbnails/image/apm-landing-page.png "New Relic APM Overview")
...
<LandingPageTileGrid>
  ...
  <LandingPageTile>
    [<i aria-hidden="true" className="fa fa-area-chart fa-3x color_apm"><span>\[search icon\]</span></i>](/docs/using-new-relic/welcome-new-relic/getting-started/get-started-improving-app-performance)
