...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [APM](/docs/apm/new-relic-apm/getting-started/introduction-new-relic-apm), [Plugins](/docs/plugins/plugins-new-relic/getting-started/introduction-new-relic-plugins)
      </td>
    </tr>
...
![Establish objectives: Insights](https://docs-dev.newrelic.com/sites/default/files/styles/inline_660px/public/thumbnails/image/catalyst-establish-objectives-2.png?itok=muMjnKzw "Establish objectives: Insights")
