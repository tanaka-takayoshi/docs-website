...
* [C SDK 1.0.0](https://docs.newrelic.com/docs/release-notes/agent-release-notes/c-sdk-release-notes) or higher
* [Go 2.0.0](https://docs.newrelic.com/docs/release-notes/agent-release-notes/go-release-notes) or higher
* [Java 4.0.0](https://docs.newrelic.com/docs/release-notes/agent-release-notes/java-release-notes) or higher
* [.NET 8.0.0](https://docs.newrelic.com/docs/release-notes/agent-release-notes/net-release-notes) or higher
* [Node.js 3.0.0](https://docs.newrelic.com/docs/release-notes/agent-release-notes/nodejs-release-notes) or higher
* [PHP 8.0.0.204](https://docs.newrelic.com/docs/release-notes/agent-release-notes/php-release-notes) or higher
* [Python 3.0.0.89](https://docs.newrelic.com/docs/release-notes/agent-release-notes/python-release-notes) or higher
* [Ruby 5.0.0.342](https://docs.newrelic.com/docs/release-notes/agent-release-notes/ruby-release-notes) or higher
...
* APM's [weekly performance reports](/docs/apm/reports/other-performance-analysis/weekly-performance-report) are not available in the EU region.
* The [Plugins](/docs/plugins) product is unavailable and is not supported in the EU region.
* Deprecated products and features are not available in the EU region.

[New Relic's Incident Intelligence](https://docs.newrelic.com/docs/new-relic-one/use-new-relic-one/new-relic-ai/get-started-incident-intelligence) service operates solely in the U.S. Whether you store your data in New Relic’s U.S. region data center or New Relic’s EU region data center, by using New Relic Incident Intelligence, you consent that New Relic may move your data to, and process your data in, the U.S. region.
...
For standard accounts, you can only have one master account. For more information, see [Manage apps or users with sub-accounts.](/docs/accounts/install-new-relic/account-setup/manage-apps-or-users-sub-accounts)

For [partnership accounts](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partnership-accounts-users-subscriptions#partnerships), no changes to the partnership owner account are required. However, data cannot be shared across regions, so a partnership requires a master account for each region.
...
<CollapserGroup>
  ...
  >
    With [partnership accounts](/docs/new-relic-partnerships/partner-integration-guide/partner-account-maintenance/partnership-accounts-users-subscriptions#partnerships), a new master account must be created for any data to be host in the EU region. This hierarchy illustrates how global accounts are structured with partnership owner accounts. Data is not aggregated beyond the master account.

    ![Sub-accounts and master accounts roll up to Partner and Partnership Owner accounts](https://docs-dev.newrelic.com/sites/default/files/thumbnails/image/Eu_account_hierarchy.png "Eu_account_hierarchy.png")
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ```
        rpm.eu.newrelic.com/api/explore/dashboards/list
        ```
      </td>
    </tr>
    ...
    <tr>
      <td>
        [Log API](https://docs.newrelic.com/docs/introduction-new-relic-logs-api)
      </td>
...
[Customer Data](/docs/licenses/license-information/product-definitions/new-relic-one-pricing-definitions#customer-data) is hosted in the region selected during [account creation](#create-eu-account). All other information, including account information (such as license subscription information, billing, and internal monitoring) is hosted in the US region and replicated in the EU region.
