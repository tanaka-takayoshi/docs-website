...
5. Optional: [Query or share the chart data](#insights) via New Relic Insights.
...
<CollapserGroup>
  ...
  >
    ![Mobile Handled Exceptions: Groups and filters](https://docs-dev.newrelic.com/sites/default/files/styles/inline_660px/public/thumbnails/image/mobile-handled-exceptions-groups.png?itok=uK7XMoPz "Mobile Handled Exceptions: Groups and filters")
...
New Relic Mobile's **Handled exceptions** charts use New Relic Insights default attributes for mobile events (including [`MobileHandledException`](/docs/insights/insights-data-sources/default-data/mobile-events-attributes#mobilehandledexception-attributes)), along with any custom attributes you have added to this event type. When you mouse over the charts, [direct links](#top5-image) appear below them. These links to New Relic Insights allow you to analyze your mobile app data even deeper.

* **View query** link: View the [Insights NRQL query](/docs/insights/new-relic-insights/using-new-relic-query-language/using-nrql) used to calculate the chart data.
* **View in Insights** link: [View the chart in Insights](/docs/insights/new-relic-insights/using-insights-interface/query-page-creating-editing-nrql-queries), and share it with others.
