...
Use the [Entity explorer](/docs/new-relic-one/use-new-relic-one/ui-data/new-relic-one-entity-explorer-view-performance-across-apps-services-hosts) and the selected ping monitor's **Summary** and **Results** pages to:
...
1. Go to **[one.newrelic.com](http://one.newrelic.com/ "Link opens in a new window.") > Entity explorer > Synthetic monitors**.
2. To find the type of result you're looking for, sort using the provided filters. For example, to view all **ping** monitors, sort by **Monitor Type**. You can also search for specific results using the [New Relic One quick find](https://docs.newrelic.com/docs/new-relic-one-core-ui-components), which is available across the New Relic One platform.
...
**[one.newrelic.com](https://one.newrelic.com) > Entity Explorer > Synthetic monitors > (select a monitor)**: View a summary of the selected ping monitor including load time and total load size.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        2. Go to **[one.newrelic.com](https://synthetics.newrelic.com) > Entity explorer > Synthetic monitors > (select a ping monitor)**
