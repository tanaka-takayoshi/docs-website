...
Use the <i className="fa fa-redo"><span>fa-redo</span></i>
...
1. Go to [**one.newrelic.com**](http://one.newrelic.com/) **> Synthetics > (select a monitor)**.
...
3. Review the failed check details, then click <i className="fa fa-redo"><span>fa-redo</span></i>
   **Run check**.
4. To view the updated status, click **See results**.

![Click Run check to recheck the monitor's status](./images/runcheck.png "Click Run check to recheck the monitor's status")

[**one.newrelic.com**](http://one.newrelic.com/) **> Synthetics > (select a monitor) > Failures > (select a check failure):** To view details about a failed monitor check, click <i className="fa fa-redo"><span>fa-redo</span></i>
**Run check**.

When you click <i className="fa fa-redo"><span>fa-redo</span></i>
