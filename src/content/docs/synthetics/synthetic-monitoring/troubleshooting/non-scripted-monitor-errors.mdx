...
<CollapserGroup id="non-scripted-errors">
  ...
  >
    ...
    Go to [**one.newrelic.com**](http://one.newrelic.com/) **> Synthetics > (select a monitor) > Settings > General > Advanced options**, then disable the **Verify SSL check**.
  ...
  >
    ...
    * Simple/Browser based monitors: Chrome 60 instance in an Ubuntu 14.04.5 VM.
