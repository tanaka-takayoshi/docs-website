    ...
    <tr>
      ...
      <td>
        ...
        * Private minion "heartbeat" every 30 seconds
        ...
        The [`SyntheticsPrivateMinion` event](https://docs.newrelic.com/attribute-dictionary?attribute_name=&events_tids%5B%5D=8392) contains basic minion status, including job success and failure counts, queue size, minion version, etc.
      </td>
    </tr>
