...
topics:
  ...
  - Private locations
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/synthetics/synthetic-monitoring/private-locations/private-locations-overview-monitor-internal-sites-add-new-locations
---
...
**![screenshot-manage-private-locations.png](https://docs-dev.newrelic.com/sites/default/files/styles/inline_660px/public/thumbnails/image/private-locations.png?itok=_rrStBVu "screenshot-manage-private-locations.png")**
...
2. Go to [**one.newrelic.com**](http://one.newrelic.com/) **> Synthetics > Private locations**. Then select <Icon name="plus-circle"/>
...
<Table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Click the <Icon name="more-horizontal"/>
