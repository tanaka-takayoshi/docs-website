...
<CollapserGroup>
  ...
  >
    ...
    ![new-relic-one-distributed-tracing-query-example-1.png](https://docs-dev.newrelic.com/sites/default/files/thumbnails/image/new-relic-one-distributed-tracing-query-example-1.png "New Relic One distributed tracing example query 1")
  ...
  >
    ...
    ![New Relic One distributed tracing - query example 2](https://docs-dev.newrelic.com/sites/default/files/thumbnails/image/new-relic-one-distributed-tracing-query-example-2.png "new-relic-one-distributed-tracing-query-example-2.png")
...
![Screenshot showing the distributed tracing scatter plot chart.](https://docs-dev.newrelic.com/sites/default/files/thumbnails/image/scatter-plot-hover.png "scatter-plot-hover.png")
...
![New Relic One distributed tracing - histogram](https://docs.newrelic.com/sites/default/files/thumbnails/image/new-relic-one-distributed-tracing-histogram-selection.png "new-relic-one-distributed-tracing-histogram-selection.png")
...
![New Relic distributed tracing UI - trace details page](https://docs-dev.newrelic.com/sites/default/files/thumbnails/image/new-relic-distributed-tracing-trace-details-UI.png "new-relic-distributed-tracing-waterfall-view.png")
...
<Table id="span-types">
  ...
  <tbody>
    <tr>
      ...
      <td>
        ![New Relic distributed tracing service icon](/sites/default/files/thumbnails/image/new-relic-distributed-tracing-service-icon.png "new-relic-distributed-tracing-service-span-icon.png")
      </td>
    ...
    <tr id="in-process">
      ...
      <td>
        ![New Relic distributed tracing in-process span icon ](/sites/default/files/thumbnails/image/new-relic-distributed-tracing-inprocess-icon.png "new-relic-distributed-tracing-in-process-span-icon.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing datastore span icon](/sites/default/files/thumbnails/image/new-relic-distributed-tracing-databases-icon.png "new-relic-distributed-tracing-database-span-icon.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing external span icon](/sites/default/files/thumbnails/image/new-relic-distributed-tracing-external-icon.png "new-relic-distributed-tracing-external-span-icon.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing browser span icon](/sites/default/files/thumbnails/image/distributed-tracing-browser-span-icon.png "distributed-tracing-browser-span-icon.png")
      </td>
...
<Table id="span-types-table">
  ...
  <tbody>
    <tr id="connecting-lines">
      ...
      <td>
        ![New Relic distributed tracing connecting lines image](/sites/default/files/thumbnails/image/new-relic-distributed-tracing-lines-image.png "new-relic-distributed-tracing-lines-image.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing error icon](/sites/default/files/thumbnails/image/new-relic-distributed-tracing-error-icon.png "new-relic-distributed-tracing-error-icon.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing orphaned span icon](/sites/default/files/thumbnails/image/new-relic-distributed-tracing-orphan-icon.png "new-relic-distributed-tracing-fragmented-icon.png")
      </td>
    ...
    <tr>
      ...
      <td>
        ![New Relic distributed tracing multiple app names indicator](/sites/default/files/thumbnails/image/new-relic-distributed-tracing-multiapp-icon.png "new-relic-distributed-tracing-multiple-app-names-indicator.png")
      </td>
...
<CollapserGroup>
  ...
  >
    ...
    * Differences in duration, due to things like network latency or DNS resolution delay
    ...
    ![New Relic distributed tracing client vs server time discrepancy diagram](https://docs.newrelic.com/sites/default/files/thumbnails/image/new-relic-distributed-tracing-client-span-time.jpg "new-relic-distributed-tracing-client-span-time.jpg")
