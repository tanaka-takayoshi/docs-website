       ...
       <Table>
         ...
         <tbody>
           <tr>
             ...
             <td>
               Copy and hold to use later as YOUR_TRACE_OBSERVER_URL in:
           ...
           <tr>
             ...
             <td>
               Copy and hold to use later as YOUR_TRACE_OBSERVER_HOST in [Step 3. (Infinite Tracing) Configure the integration](#configure-integration).
             </td>
           </tr>
         </tbody>
       </Table>
...
<CollapserGroup>
  <Collapser
    ...
    title="Istio adapter"
  >
    Set the [`spansHost`](https://github.com/newrelic/newrelic-istio-adapter/blob/master/helm-charts/values.yaml#L40-L41) value with YOUR_TRACE_OBSERVER_URL when [deploying the Helm chart](https://github.com/newrelic/newrelic-istio-adapter/tree/master#deploy-helm-template).
  </Collapser>
  ...
  >
    Set the [`span-ingest-uri`](https://kamon.io/docs/latest/reporters/newrelic/) value with YOUR_TRACE_OBSERVER_URL in your `kamon.newrelic` configuration block.
  </Collapser>
  ...
  >
    Set the [`SpansURLOverride`](https://godoc.org/github.com/newrelic/newrelic-telemetry-sdk-go/telemetry#Config) field on the `Config` object with YOUR_TRACE_OBSERVER_URL when creating the [Exporter](https://godoc.org/github.com/newrelic/newrelic-opencensus-exporter-go/nrcensus#NewExporter).
  </Collapser>
  ...
  >
    Pass the host parameter to the [Trace Exporter](https://newrelic.github.io/newrelic-opencensus-exporter-python/api.html#opencensus_ext_newrelic.trace.NewRelicTraceExporter) using YOUR_TRACE_OBSERVER_HOST.
  </Collapser>
  ...
  >
    Set the [`SpansURLOverride`](https://godoc.org/github.com/newrelic/newrelic-telemetry-sdk-go/telemetry#Config) field on the `Config` object with YOUR_TRACE_OBSERVER_URL when creating the [Exporter](https://godoc.org/github.com/newrelic/opentelemetry-exporter-go/newrelic#NewExporter).
  </Collapser>
  ...
  >
    Configure the [`TraceUrlOverride`](https://github.com/newrelic/newrelic-telemetry-sdk-dotnet/blob/master/src/NewRelic.Telemetry/TelemetryConfiguration.md#advanced-configuration-options) parameter with YOUR_TRACE_OBSERVER_URL.
  </Collapser>
</CollapserGroup>
