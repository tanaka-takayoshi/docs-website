---
title: 'Infinite Tracing: Span attribute trace filter'
contentType: page
template: basicDoc
topics:
...
3. Under **Create new rule**, enter `user` below **Span key**, and then in the **Key operator** dropdown, select the value **Equals**:
   ...
   ![Screenshot showing how to enter a span key.](https://docs-dev.newrelic.com/sites/default/files/thumbnails/image/span_key.png "span_key.png")
4. Under **Span value**, enter `sally@some_company.com`, and then in the **Value operator** dropdown, select **Equals**.

   ![Screenshot showing how to enter a span value.](https://docs-dev.newrelic.com/sites/default/files/thumbnails/image/span_value.png "span_value.png")
