...
topics:
  ...
  - Service maps
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/understand-dependencies/understand-system-dependencies/service-maps/how-use-service-maps
---
...
To view service maps, from [one.newrelic.com](https://one.newrelic.com) click **Entity explorer**. Once you select an entity to view, you can select service maps from the sidebar.
...
You can add any service map to a [dashboard](/docs/dashboards/new-relic-one-dashboards/get-started/introduction-new-relic-one-dashboards). For example, if you have a dashboard showcasing performance metrics for several entities, adding a service map to the dashboard shows how all the entities are related and provides additional context about your system.

To add a service map to a dashboard:

1. Go to [one.newrelic.com](https://one.newrelic.com) and select the **Entity explorer**.
...
If you are unable to view certain entities in New Relic One service maps, see [Troubleshooting: Missing or obfuscated data in New Relic One](https://docs.newrelic.com/docs/troubleshooting-missing-or-obfuscated-data-new-relic-one).
