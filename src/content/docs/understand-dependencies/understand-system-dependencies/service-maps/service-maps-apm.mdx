...
1. Do one of the following:
   * Start from scratch: Go to **[one.newrelic.com](https://one.newrelic.com) > More > Service maps > Map list > Create new map <Icon name="plus-circle"/>
     **.
...
<CollapserGroup>
  ...
  >
    ...
    2. Select the pencil <Icon name="edit-2"/>
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://rpm.newrelic.com/apm) > More > Service maps > (select a map)**.
    2. Select the pencil <Icon name="edit-2"/>
       icon next to the map name.
    3. Clear the **Make this map private** checkbox.
    4. To share a link to the map, select its [**permalink**](/docs/data-analysis/user-interface-functions/permalink).
  </Collapser>
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://rpm.newrelic.com/apm) > More > Service maps > (select a map)**.
    2. Select **Change owner**, or select the pencil <Icon name="edit-2"/>
       icon next to the map name.
...
<CollapserGroup>
  ...
  >
    Nodes for applications, mobile apps, and plugins (including databases) need to be added to the map in order to add any other nodes. Nodes are added and connected into the map as you select them. The check mark <Icon name="check"/>
  ...
  >
    ...
    2. From the list of connections, mouse over an app or service, then select the plus <Icon name="plus"/>
       icon.
    3. [Rearrange](#select-arrange-group-nodes) as needed.

    ![crop-incoming-outgoing-service-maps.png](https://docs-dev.newrelic.com/sites/default/files/thumbnails/image/crop-incoming-outgoing-service-maps.png "crop-incoming-outgoing-service-maps.png")
  </Collapser>
  ...
  >
    ...
    3. Name the node.
    4. Add connections: Select the left (for incoming) or right (for outgoing) arrow <i className="fa fa-arrow-right"><span>arrow-right</span></i>
       icons. Then select the plus <Icon style={{color: '#B9D7B6'}} name="plus-circle"/>
    ...
    1. Mouse over the custom node and select the pencil <Icon name="edit-2"/>
       icon.
    2. Select the left (for incoming) or right (for outgoing) arrow <i className="fa fa-arrow-right"><span>arrow-right</span></i>
       icons.
    3. To add a connection, select the plus <Icon style={{color: '#B9D7B6'}} name="plus-circle"/>
       icon.
    4. To remove a connection, select the minus <Icon style={{color: '#D75968'}} name="minus-circle"/>
       icon.
    5. Select **Save**.

    ![crop-custom-connections-service-maps.png](https://docs-dev.newrelic.com/sites/default/files/thumbnails/image/crop-custom-connections-service-maps.png "crop-custom-connections-service-maps.png")
  </Collapser>
</CollapserGroup>
...
<Table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        * In pan <i className="fa fa-arrows"><span>arrows</span></i>
          mode, click and drag.
        * In drag-select ![](/sites/default/files/thumbnails/image/sm-drag-select-toggle_0.png) mode, hold the **Alt** key, then click and drag.
      </td>
    </tr>
...
<CollapserGroup>
  ...
  >
    ...
    * Click the drag-select ![](/sites/default/files/thumbnails/image/sm-drag-select-toggle_0.png) icon to switch to drag-select mode. Click and drag the mouse to draw a square around the nodes you want to select.
    ...
    <Table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Select two or more nodes, then select ![](/sites/default/files/thumbnails/image/sm-grouping-icon.png) **Create group**.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Mouse over the group, then select the pencil <Icon name="edit-2"/>
            icon.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Select the pencil <Icon name="edit-2"/>
            icon.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Select the group, then select the minus <Icon name="minus-circle"/>
            icon for each item you want to remove.

            ![](/sites/default/files/thumbnails/image/crop-service-map-app-group.png)
          </td>
        </tr>
      </tbody>
    </Table>
...
1. Go to **[one.newrelic.com](https://one.newrelic.com) > More > Service maps > (select a map)**.
2. Select the map name's pencil <Icon name="edit-2"/>
   icon.
3. Select **Delete map**.
...
<CollapserGroup>
  ...
  >
    ...
    ![crop-service-map-app-group.png](/sites/default/files/thumbnails/image/crop-service-map-app-group.png "crop-service-map-app-group.png")
  </Collapser>
  ...
  >
    ...
    ![Zoom out of your service map to view in traffic lights mode](https://docs-dev.newrelic.com/sites/default/files/thumbnails/image/traffic-lights_service-maps_APM.jpg "traffic-lights_service-maps_APM.jpg")
