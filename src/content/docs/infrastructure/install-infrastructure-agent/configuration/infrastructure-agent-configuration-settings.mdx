...
For an example of how all these variables can be used, see our [sample configuration template](https://github.com/newrelic/infrastructure-agent/blob/master/assets/examples/infrastructure/newrelic-infra-template.yml.example).

<Callout variant="important">
  [`license_key`](#license-key) is the only required setting.
</Callout>
...
<CollapserGroup>
  ...
  >
    Specifies the [license key](/docs/accounts-partnerships/accounts/account-setup/license-key) for your New Relic account. The agent uses this key to associate your server's metrics with your New Relic account. This setting is created as part of the standard installation process.
...
If the agent is running in a cloud instance, the agent will try to detect the cloud type and fetch [metadata](/docs/integrations/new-relic-integrations/getting-started/understand-use-data-infrastructure-integrations).
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            [1.11.4](https://docs.newrelic.com/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes/new-relic-infrastructure-agent-1114-0) when forwarding the New Relic Logs (`3`)
          </td>
        </tr>
      </tbody>
    </Table>
...
<CollapserGroup>
  ...
  >
    ...
    If you want to send metric data about all the operating system's processes to New Relic, set `enable_process_metrics` to `true`. To disable the sending of process data, set it to `false`.
