...
The agent requires its own defined directory to run the installed [integrations](/docs/integrations), caching data (inventory), etc. The default location is `/var/db/newrelic-infra/`.
