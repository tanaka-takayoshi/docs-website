...
As part of [Applied Intelligence](https://docs.newrelic.com/docs/introduction-new-relic-ai), **Incident Intelligence** helps you correlate your incidents and reduce noise in your environment. It gives you an overview of all your incidents, their sources, and related events.

## How it works

After you [set up Incident Intelligence](#get-started), our system will begin finding issues from your data sources.
...
![This image shows the AI issue feed in New Relic One.](./images/ai-issue-feed.png "ai-issue-feed.png")
...
<CollapserGroup>
  ...
  >
    ...
    1. From **[one.newrelic.com](https://one.newrelic.com)**, click **Alerts & AI**, then click **Go to Incident Intelligence.**
  ...
  >
    ...
    2. From **[one.newrelic.com](https://one.newrelic.com)**, click **Alerts & AI**, then click **Go to Incident Intelligence.**
  ...
  >
    ...
    * Correlate alerts and search reports with your other metrics and incidents.
    ...
    3. Go to **[one.newrelic.com](https://one.newrelic.com)**, click **Alerts & AI**, in the left nav under **Incident Intelligence** click **Sources**, then click **Splunk**.
    4. Copy the collector URL, and paste it into the webhook endpoint in the Splunk console.
    5. Optional: Use Splunk tokens to [enrich alert data with Splunk metadata](#enrich-splunk-search).
  </Collapser>
  ...
  >
    ...
    1. Set up your Alertmanager configuration file by running:
       ...
       ```
    2. Go to **[one.newrelic.com](https://one.newrelic.com)**, click **Alerts & AI**, in the left nav under **Incident Intelligence** click **Sources**, then click **Prometheus Alertmanager**.
  ...
  >
    ...
    3. Go to **[one.newrelic.com](https://one.newrelic.com)**, click **Alerts & AI**, in the left nav under **Incident Intelligence** click **Sources**, then click **Grafana**.
  ...
  >
    ...
    1. Go to **[one.newrelic.com](https://one.newrelic.com)**, click **Alerts & AI**, in the left nav under **Incident Intelligence** click **Sources**, then click **Amazon Web Services**.
    2. Copy the URL.
    3. [Create a new Amazon SNS topic](https://docs.aws.amazon.com/sns/latest/dg/sns-getting-started.html).
...
<CollapserGroup>
  ...
  >
    ...
    ![service-now-new-field](./images/service-now-new-field.png "service-now-new-field")
...
If you’re using **PagerDuty** as your incident notification tool, Incident Intelligence suggests relevant team members that can help resolve your issues.

Incident Intelligence learns from your PagerDuty alert data to provide suggestions for each new incident. Once you receive a suggestion, you can contact the responder or search for relevant documentation that person may have authored.

To get started, enable PagerDuty as a source for Incident Intelligence. Afterwards, you can view the suggestions in two places:
