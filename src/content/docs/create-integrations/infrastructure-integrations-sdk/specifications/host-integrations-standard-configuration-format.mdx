...
New Relic Infrastructure [on-host integrations](/docs/integrations/host-integrations/getting-started/introduction-host-integrations) can use one of two types of [configuration formats](/docs/integrations/integrations-sdk/file-specifications/config-file-overview). This document explains the older, standard configuration format. This format is used by most on-host integrations and is supported by newer Infrastructure agents (which also support a [newer, improved configuration format](/docs/integrations/host-integrations/configuration/host-integrations-newer-configuration-format)).
