...
New Relic Infrastructure [on-host integrations](/docs/integrations/host-integrations/getting-started/introduction-host-integrations) can use one of two types of [configuration formats](/docs/integrations/integrations-sdk/file-specifications/config-file-overview).

In December 2019, [Infrastructure agent version 1.8.0](https://docs.newrelic.com/docs/release-notes/infrastructure-release-notes/infrastructure-agent-release-notes) began supporting a newer configuration format that makes use of a single configuration file (instead of two separate files), and provides other improvements. This document will explain how this newer format works.

The older [standard configuration format](/docs/integrations/host-integrations/configuration/host-integrations-standard-configuration-specs) is supported by current Infrastructure agents.
...
Each configuration YAML file can also contain [`discovery`](https://docs.newrelic.com/docs/integrations/host-integrations/installation/container-auto-discovery) and [`variables`](https://docs.newrelic.com/docs/integrations/host-integrations/installation/secrets-management) top-level sections.
...
* Environment variables, using the [`env` property](#env).
...
<CollapserGroup>
  ...
  >
    ...
    If you expect your integration to receive the configuration from the host's environment rather than specifying it explicitly in the configuration file, you need to set the required variables in the Infrastructure agent [`passthrough_environment`](https://docs.newrelic.com/docs/integrations/host-integrations/troubleshooting/pass-infrastructure-agent-parameters-host-integration) global configuration property
  </Collapser>
  ...
  >
    ...
    1. The agent applies [secrets management](https://docs.newrelic.com/docs/integrations/host-integrations/installation/secrets-management) and [discovery](https://docs.newrelic.com/docs/integrations/host-integrations/installation/container-auto-discovery) to the file contents.
