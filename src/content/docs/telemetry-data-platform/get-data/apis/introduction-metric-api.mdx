...
topics:
  ...
  - Ingest APIs
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/telemetry-data-platform/get-data/apis/introduction-metric-api
---
...
You'll need a New Relic [Insert API key](https://docs.newrelic.com/docs/insights/insights-data-sources/custom-data/send-custom-events-event-api#register). For information on limits and restricted attributes, see [Metric API requirements and limits](https://docs.newrelic.com/docs/metric-api-general-requirements-limits).
...
* By querying the `Metric` data type. For example, you can use [NRQL](https://docs.newrelic.com/docs/query-data/nrql-new-relic-query-language/getting-started/introduction-nrql) to run:
  ...
  For more on querying, see [Metric query examples](/docs/data-ingest-apis/get-data-new-relic/metric-api/view-query-you-metric-data). For information on querying in general, see [Query data](https://docs.newrelic.com/docs/using-new-relic/data/understand-data/query-new-relic-data).
