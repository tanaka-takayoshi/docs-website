...
japaneseVersion: >-
  https://docs.newrelic.co.jp/docs/telemetry-data-platform/get-data/apis/query-metric-data-type
---
...
New Relic APM reports a specific type of data that we call metric timeslice data. For how to query that, see [Query metric timeslice data](/docs/query-data/nrql-new-relic-query-language/nrql-query-tutorials/query-metric-timeslice-data-nrql).
...
Below are the functions supported for each [metric type](https://docs.newrelic.com/docs/report-metrics-metric-api#payload-metrics):
