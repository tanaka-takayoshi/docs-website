...
The New Relic platform is built around [four telemetry data types](/docs/telemetry-data-platform/ingest-manage-data/understand-data/new-relic-data-types) we believe are necessary for complete and effective system monitoring: metrics, events, logs, and traces.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        * is generated only via the [event-to-metrics service](/docs/accounts/accounts/data-management/introduction-events-metrics-service).
